...
export class AddDespesaComponent {
  ...
  ngOnInit() {
    ...
    this.despesaForm = this._fb.group({
      ...
      parcelas: ['2', [Validators.required, regexValidator(/^(?:[2-9]|[1-9][0-9]|100)$/)]],
      diaVencimento: ['1', [Validators.required, regexValidator(/^(?:[1-9]|[12]\d|3[01])$/)]],
      mesVencimento: ['1', [Validators.required, regexValidator(/^(0[1-9]|1[0-2])-(19|20)\d{2}$/)]],
    });
  }
